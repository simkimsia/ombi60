...
?>
 <div id="search">
    ...
    <div id="startsearch">
        <!--Product Search page-->
        <h2><?php echo __('1. Start typing the name of a product')?></h2>
        <?php
            ...
            echo $this->Form->end();
        ?>
        <p><?php echo __("You can narrow down the list of products by typing a few letters of a product's title.", false);?></p>
        <br />
        <h2><?php echo __('2. Select products you want to add', FALSE)?></h2>
