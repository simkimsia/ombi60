...
<p>Go to the <a href="/admin/pages">Blogs &amp; Pages</a> in administration menu.</p>',
	...
	**/	
	...
	/**
	* Function checks for password and email and shop_id to ensure the correct login
	*
	* @param $shop_id int Shop id
	* @param $email string Email
	* @param $password string the Plain password
	* @return boolean Return true if exist
	**/
	public function checkMerchantForLogin($shop_id, $email, $password) {
		
		$hash_password = AuthComponent::password($password);
