<div class="webpages main-container-div">
      <div class="text_center">
        <h2><?php echo $blog_name; ?> - <?php __('Add your New Article');?></h2>
        <?php echo $this->Html->link(__('Cancel', true), array('controller'=>'blogs','action' => 'view', $blog_id));?>
    </div>
...
<?php echo $this->Form->create('Post', array('url'=>array('controller'=>'posts',
					     ...
					     'blog_id'=>$blog_id)));?>
	<fieldset>
 		<legend><?php __('New Article'); ?></legend>
	<?php
  ...
  <div class="submit">
    <?php echo $this->Form->submit(__('Create article', true), array('div' => false));?> &nbsp;<?php __('or'); ?>&nbsp;
    <?php echo $this->Html->link(__('Cancel', true), array('controller'=>'blogs','action' => 'view', $blog_id));?>
  </div>
