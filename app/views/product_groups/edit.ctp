...
<?php echo $this->Form->create('ProductGroup');?>
	<fieldset>
 		<legend><?php __('Edit Product Group'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProductGroup.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProductGroup.id'))); ?></li>
