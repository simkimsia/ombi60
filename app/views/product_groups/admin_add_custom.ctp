<div class="collections">
      <div class="text_center">
        <h2><?php __('Add your New Custom Collection');?></h2>
...
<?php echo $this->Form->create('ProductGroup');?>
	<fieldset>
 		<legend><?php __('New Custom Collection'); ?></legend>
	<?php
	...
	<fieldset>
 		...
 		<label><?php __('Custom Collection Visibility');?></label>
  ...
  <div class="submit">
    <?php echo $this->Form->submit(__('Create Custom Collection', true), array('div' => false));?> &nbsp;<?php __('or'); ?>&nbsp;
    <?php echo $this->Html->link(__('Cancel', true), array('controller'=>'product_groups','action' => 'index')); ?>
  </div>
