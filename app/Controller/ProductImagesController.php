...
class ProductImagesController extends AppController {
	...
	public function admin_uploadify() {
	...
	public function admin_list_by_product($product_id = null) {
	...
	public function admin_ajax_product_image_upload($product_id = null, $edit = null) {
		if (!$product_id) {
			return false;
		}
	...
	public function admin_delete_me($id = null, $product_id = null) {
		if ($this->request->params['isAjax']) {
			$this->layout = false;
		}
		if (!$id OR !$product_id) {
