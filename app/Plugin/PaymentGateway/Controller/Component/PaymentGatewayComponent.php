...
/**
 * 
 * This class implements PaymentGateway component to abstract payments module and calls specific 
 * gateway components methods
 * @author ajibarra
 *
 */
class PaymentGatewayComponent extends Component {
	const PAYPAL_EXPRESS = 'Paypal Express Checkout';
	
	public $components = array('PaymentGateway.PaypalExpress');
