...
require_once App::pluginPath('PaymentGateway') . 'Vendor' . DS . 'AktiveMerchant'.DS.'lib'.DS.'merchant'.DS.'billing'.DS.'Expect.php';
require_once App::pluginPath('PaymentGateway') . 'Vendor' . DS . 'AktiveMerchant'.DS.'lib'.DS.'merchant'.DS.'billing'.DS.'Gateway.php';
...
require_once App::pluginPath('PaymentGateway') . 'Vendor' . DS . 'AktiveMerchant'.DS.'lib'.DS.'merchant'.DS.'billing'.DS.'gateways'.DS.'PaypalExpress.php';
