<?php
/* SVN FILE: $Id: post.php 141 2009-08-30 17:13:28Z miha@nahtigal.com $ */
/**
 ...
 */
	function __construct($id = false, $table = null, $ds = null)	{
		...
		$this->belongsTo['Author'] = Configure::read('LilBlogsPlugin.userTable');
		...
		} else if ($category_assoc = Configure::read('LilBlogsPlugin.categoryTable')) {
