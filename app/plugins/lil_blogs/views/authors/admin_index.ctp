<div class="head">
	...
	<div><?php echo $html->link($html->image('/lil_blogs/img/add.gif').' '.__d('lil_blogs', 'Create a new Author', true), array('action'=>'admin_add'), null, null, false); ?></div>
</div>
<div class="index">
...
<?php foreach($authors as $item) { ?>
	<tr>
		...
		<td><?php echo $sanitize->html($item['Author'][Configure::read('LilBlogsPlugin.authorDisplayField')]); ?></td>
