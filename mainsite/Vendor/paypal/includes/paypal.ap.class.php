...
class PayPalAdaptivePayments
{
	...
	function PayPalAdaptivePayments($DataArray)
	{
		...
		$this -> APIVersion = isset($DataArray['APIVersion']) ? $DataArray['APIVersion'] : '60.0';
		...
		else
		{
			...
			$this -> APIUsername = isset($DataArray['APIUsername']) && $DataArray['APIUsername'] != '' ? $DataArray['APIUsername'] : 'YOUR_API_USERNAME';
			$this -> APIPassword = isset($DataArray['APIPassword']) && $DataArray['APIPassword'] != ''  ? $DataArray['APIPassword'] : 'YOUR_API_PASSWORD';
			$this -> APISignature = isset($DataArray['APISignature']) && $DataArray['APISignature'] != ''  ? $DataArray['APISignature'] : 'YOUR_API_SIGNATURE';
