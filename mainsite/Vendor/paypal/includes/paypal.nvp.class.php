...
/*
	**************************************************
	...
	PayPal Pro NVP API Documentation : May 2010
	API Version 63.0
	**************************************************
	...
	** NOTE ** API credentials may be hard-coded within this class as an alternative to passing it with each session.
	...
	for whether or not you want to display a review page on your site, so PayPal's review will say "continue" or if you want to skip your own review 
	so PayPal's review page says "Pay Now" instead.
...
class PayPal
{
	...
	function PayPal($DataArray)
	{
		...
		$this -> APIButtonSource = isset($DataArray['ButtonSource']) ? $DataArray['ButtonSource'] : 'OMBI60_3RD_PARTY_FOR_SHOP';
	...
	function DoExpressCheckoutPayment($DataArray)
	{
		...
		*/	
		...
		foreach($UserSelectedOptions as $UserSelectedOptionVar => $UserSelectedOptionVal)
			$UserSelectedOptionsNVP .= '&' . strtoupper($UserSelectedOptionVar) . '=' . $UserSelectedOptionVal;
