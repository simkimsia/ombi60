...
insert  into `logs`(`id`,`title`,`created`,`description`,`model`,`model_id`,`action`,`user_id`,`change`) values (1,'Dummy Product','2011-04-18 06:18:32','Product \"Dummy Product\" (2) added by System.','Product',2,'add',0,'price, visible, weight, currency, shipping_required, vendor_id, shop_id, title, handle, created'),(2,'Dummy Product','2011-04-18 06:18:33','Product (2) updated by System.','Product',2,'edit',0,'shop_id'),(3,'Dummy Product','2011-04-18 06:25:59','Product \"Dummy Product\" (3) added by System.','Product',3,'add',0,'price, visible, weight, currency, shipping_required, vendor_id, shop_id, title, handle, created');
...
insert  into `product_images`(`id`,`product_id`,`cover`,`created`,`modified`,`filename`,`dir`,`mimetype`,`filesize`) values (1,1,1,'2010-05-20 07:59:19','2010-05-20 07:59:19','default.jpg','uploads\\products','image/jpeg',6103),(2,2,1,'2011-04-18 06:18:33','2011-04-18 06:18:33','default-0.jpg','uploads/products','image/jpeg',6103),(3,3,1,'2011-04-18 06:26:00','2011-04-18 06:26:00','default_0.jpg','uploads/products','image/jpeg',6103);
...
insert  into `products`(`id`,`shop_id`,`title`,`code`,`description`,`price`,`created`,`modified`,`visible`,`weight`,`currency`,`shipping_required`,`vendor_id`,`handle`) values (1,1,'Dummy Product',NULL,NULL,'0.0000','2010-05-20 08:00:24','2010-05-20 08:00:24',1,7000,'SGD',1,0,NULL),(2,2,'Dummy Product',NULL,NULL,'0.0000','2011-04-18 06:18:32','2011-04-18 06:18:33',1,7000,'SGD',1,0,'dummy-product'),(3,2,'Dummy Product',NULL,NULL,'0.0000','2011-04-18 06:25:59','2011-04-18 06:25:59',1,7000,'SGD',1,0,'dummy-product-1');
...
insert  into `products_in_groups`(`id`,`product_id`,`product_group_id`) values (1,2,1),(2,3,1);
