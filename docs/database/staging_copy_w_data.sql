...
insert  into `blogs`(`id`,`title`,`short_name`,`description`,`theme`,`created`,`modified`,`shop_id`,`visible_post_count`,`all_post_count`) values (1,'shop001','shop001',NULL,NULL,'2011-06-19 05:27:31','2011-06-19 05:27:31',2,1,1);
...
insert  into `invoices`(`id`,`created`,`title`,`shop_id`,`description`,`payment_number`,`payer_user`,`reference`) values (1,'2011-06-19 05:27:31','starter',2,'Initial signup',NULL,NULL,'2011-06-19-0527-1');
...
insert  into `logs`(`id`,`title`,`created`,`description`,`model`,`model_id`,`action`,`user_id`,`change`) values (1,'Dummy Product','2011-06-19 05:27:32','Product \"Dummy Product\" (2) added by System.','Product',2,'add',0,'price, visible, weight, currency, shipping_required, vendor_id, product_type_id, shop_id, title, handle, created'),(2,'Dummy Product','2011-06-19 05:27:32','Product (2) updated by System.','Product',2,'edit',0,'shop_id, vendor_id, product_type_id'),(3,'test','2011-06-19 09:53:21','Product \"test\" (2) updated by System.','Product',2,'edit',0,'title');
...
insert  into `posts`(`id`,`blog_id`,`author_id`,`visible`,`title`,`slug`,`content`,`no_comments`,`allow_comments`,`allow_pingback`,`created`,`modified`,`published`) values (1,1,1,1,'Open for business!','open-for-business','We are OPEN for business!!',0,1,1,'2011-06-19 05:27:31','2011-06-19 05:27:31',NULL);
...
insert  into `product_groups`(`id`,`title`,`shop_id`,`created`,`modified`,`description`,`all_product_count`,`handle`,`vendor_count`,`visible`,`type`,`visible_product_count`) values (1,'Frontpage',2,'2011-06-19 05:27:32','2011-06-19 20:45:50',NULL,1,'frontpage',0,1,0,0),(2,'test',2,'2011-06-19 09:52:55','2011-06-19 20:45:50','',1,'test',0,1,1,0);
...
insert  into `product_types`(`id`,`shop_id`,`created`,`modified`,`title`,`handle`,`visible_product_count`,`all_product_count`) values (1,2,'2011-06-19 05:27:31','2011-06-19 05:27:31','Shirts','shirts',1,1);
...
insert  into `products_in_groups`(`id`,`product_id`,`product_group_id`) values (1,2,1),(2,2,2);
...
insert  into `recurring_payment_profiles`(`id`,`gateway`,`method`,`shop_id`,`gateway_reference_id`,`created`,`modified`,`status`) values (1,'paydollar','AddSchPay API',2,'11368','2011-06-19 05:27:34','2011-06-19 05:27:34','active');
...
insert  into `saved_themes`(`id`,`name`,`description`,`author`,`created`,`modified`,`folder_name`,`shop_id`,`theme_id`,`featured`) values (1,'default','default','shop001','2011-06-19 05:27:31','2011-06-19 05:27:31','2_cover',2,3,1);
...
insert  into `smart_collection_conditions`(`id`,`smart_collection_id`,`field`,`relation`,`condition`,`created`,`modified`) values (1,2,'Product.title','equals','test','2011-06-19 09:52:55','2011-06-19 09:52:55');
...
insert  into `variants`(`id`,`title`,`product_id`,`sku_code`,`weight`,`created`,`modified`,`currency`,`shipping_required`,`price`,`order`,`compare_with_price`) values (1,'Default Title',1,NULL,7000,NULL,NULL,'SGD',1,'0.0000',1,NULL),(2,'Default Title',2,NULL,7000,'2011-06-19 05:27:32','2011-06-19 05:27:32','SGD',1,'0.0000',1,NULL);
...
insert  into `vendors`(`id`,`shop_id`,`created`,`modified`,`title`,`handle`,`visible_product_count`,`all_product_count`) values (1,2,'2011-06-19 05:27:31','2011-06-19 05:27:31','OMBI60','ombi60',1,1);
