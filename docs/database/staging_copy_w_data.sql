...
insert  into `logs`(`id`,`title`,`created`,`description`,`model`,`model_id`,`action`,`user_id`,`change`) values (1,'Dummy Product','2011-06-20 10:58:10','Product \"Dummy Product\" (2) added by System.','Product',2,'add',0,'price, visible, weight, currency, shipping_required, vendor_id, product_type_id, shop_id, title, handle, created'),(2,'Dummy Product','2011-06-20 10:58:11','Product (2) updated by System.','Product',2,'edit',0,'shop_id, vendor_id, product_type_id');
...
insert  into `product_groups`(`id`,`title`,`shop_id`,`created`,`modified`,`description`,`all_product_count`,`handle`,`vendor_count`,`visible`,`type`,`visible_product_count`) values (1,'Frontpage',2,'2011-06-20 10:58:11','2011-06-20 10:58:11',NULL,1,'frontpage',0,1,0,1);
...
insert  into `product_images`(`id`,`product_id`,`cover`,`created`,`modified`,`filename`,`dir`,`mimetype`,`filesize`) values (1,1,1,'2010-05-20 07:59:19','2010-05-20 07:59:19','default.jpg','uploads\\products','image/jpeg',6103),(2,2,1,'2011-06-20 10:58:10','2011-06-20 10:58:10','default-0.jpg','uploads/products','image/jpeg',6103);
...
insert  into `users`(`id`,`email`,`password`,`group_id`,`full_name`,`name_to_call`,`last_login_on`,`status`,`created`,`modified`,`language_id`) values (1,'owner@shop001.com','78e8f77082028fa96a619aa568aa3ca88a72ec8e',3,'asd','asd',NULL,1,'2011-06-20 10:58:09','2011-06-20 10:58:09',1);
...
insert  into `variants`(`id`,`title`,`product_id`,`sku_code`,`weight`,`created`,`modified`,`currency`,`shipping_required`,`price`,`order`,`compare_with_price`) values (1,'Default Title',1,NULL,7000,NULL,NULL,'SGD',1,'0.0000',1,NULL),(2,'Default Title',2,NULL,7000,'2011-06-20 10:58:10','2011-06-20 10:58:10','SGD',1,'0.0000',1,NULL);
