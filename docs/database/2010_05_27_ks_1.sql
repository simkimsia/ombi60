...
insert  into `addresses`(`id`,`address`,`city`,`region`,`zip_code`,`country`) values (1,'qwe','qwe','qwe','123456','qwe');
...
insert  into `customers`(`id`,`identity_code`,`shop_id`,`user_id`) values (1,NULL,5,7);
...
insert  into `order_line_items`(`id`,`order_id`,`product_id`,`product_price`,`product_quantity`,`status`) values (1,56,3,123.00,3,1),(4,58,3,123.00,3,1),(5,58,4,123.00,3,1);
